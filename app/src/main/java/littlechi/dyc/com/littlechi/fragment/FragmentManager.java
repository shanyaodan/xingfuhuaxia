...
public class FragmentManager {
	...
	public static void setFragmentWithStrName(FragmentActivity fragmentActivity,
		...
		.replace(layout,BaseFragment.getInstance(fragmentActivity, fragmentName),fragmentName).commit();
	}
	...
	public static void setMainFragmentWithStrName(
	...
	private static void setMainFragment(FragmentActivity fragmentActivity,
		...
		synchronized (fragmentActivity) {
			...
			if (fragments.containsKey(name) && null != fragments.get(name)) {
				...
				setMainFragmentWithStrName(fragmentActivity, name,
						R.id.fragmentlayout);
			}
		}
	}
